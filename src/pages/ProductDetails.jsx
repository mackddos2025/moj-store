  ...
  useEffect(() => {
    const fetchProductDetails = async () => {
      try {
        ...
        const relatedResponse = await fetch(`https://fakestoreapi.com/products/category/${data.category}?limit=4`);
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <tr>
                    ...
                    <td className="py-3 text-sm text-gray-900 dark:text-gray-100">{product.rating?.rate} من 5</td>
                  </tr>
                  <tr>
                    <td className="py-3 text-sm font-medium text-gray-500 dark:text-gray-400">عدد التقييمات</td>
                    <td className="py-3 text-sm text-gray-900 dark:text-gray-100">{product.rating?.count}</td>
                  </tr>
                </tbody>
              </table>
            </div>
